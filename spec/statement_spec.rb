...
describe Statement do
  ...
  describe "#view_statement" do
    ...
    it "returns the transactions in reverse chronological order" do
      STATEMENT_1 = ["date || credit || debit || balance", "02/12/2018 || || 40.00 || 60.00", "02/12/2018 || 100.00 || || 100.00"]
  ...
  describe "#update" do
    it "updates the statment when a deposit is made" do
      STATEMENT_2 = ["date || credit || debit || balance", "02/12/2018 || 100.00 || || 100.00"]
      subject.update("02/12/2018 || 100.00 || || 100.00")
      expect(subject.view_statement).to eq STATEMENT_2
    end
    it "updates the statment when a withdrawal is made" do
      STATEMENT_3 = ["date || credit || debit || balance", "02/12/2018 || || 40.00 || 60.00"]
      subject.update("02/12/2018 || || 40.00 || 60.00")
      expect(subject.view_statement).to eq STATEMENT_3
    end
  end
end
